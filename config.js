...
exports.systemEmail = 'paul.freelance@gmail.com';
...
exports.smtp = {
  from: {
    ...
    address: process.env.SMTP_FROM_ADDRESS || 'paul.freelance@gmail.com'
  },
  credentials: {
    user: process.env.SMTP_USERNAME || 'paul.freelance@gmail.com',
    password: process.env.SMTP_PASSWORD || 'cat2cute',
